...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("List of Files");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("C:\\Files_Pro");
    ...
    private void connectToServer(){
        if(txtHost.getText().length() > 0 && txtPort.getText().length() > 0 && txtUsername.getText().length() > 0){
            if(txtUsername.getText().length() <= 15){
                ...
                main.initFrame(u, txtHost.getText(), Integer.parseInt(txtPort.getText()), jTextArea1.getText());
